...
<li>	
	...
	<a href="#" title="{phrase var='friend.friend_requests'}" class="friend_notification notify_drop_link" rel="friend.getRequests">{phrase var='friend.friend_requests'}<span>Люди</span></span></a>
