...
<?php else:  if (! Phpfox ::getService('profile')->timeline()):  /* Cached: August 27, 2012, 8:55 am */  
/**
 * [PHPFOX_HEADER]
 * 
 * @copyright		[PHPFOX_COPYRIGHT]
...
<?php else: ?>
<?php /* Cached: August 27, 2012, 8:55 am */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: August 27, 2012, 8:55 am */  if (Phpfox ::getParam('like.show_user_photos')): ?>
