...
<?php /* Cached: August 16, 2012, 10:37 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php else:  if (! Phpfox ::getService('profile')->timeline()):  /* Cached: August 16, 2012, 10:37 pm */  
/**
 * [PHPFOX_HEADER]
 * 
 * @copyright		[PHPFOX_COPYRIGHT]
							...
							
{
 ...
 / <?php $aYears = range(2012, 1900);   $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); ?>		<select name="val[start_year]" id="start_year" class="js_datepicker_year">
...
<?php else: ?>
<?php /* Cached: August 16, 2012, 10:37 pm */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: August 16, 2012, 10:37 pm */  if (Phpfox ::getParam('like.show_user_photos')): ?>
