 ...
 * @version 		$Id: index.class.php 5141 2013-01-15 10:59:09Z Miguel_Espinoza $
 */
class Photo_Component_Controller_Index extends Phpfox_Component
{
	...
	{		
		...
		if (
			...
			&& $this->request()->get('req3') != 'photos' && $this->request()->get('view') != 'photos' && !is_numeric($this->request()->get('req2'))
