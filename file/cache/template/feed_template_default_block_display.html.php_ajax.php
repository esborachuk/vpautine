...
<?php else:  if (! Phpfox ::getService('profile')->timeline()):  /* Cached: August 25, 2012, 12:00 am */  
/**
 * [PHPFOX_HEADER]
 * 
 * @copyright		[PHPFOX_COPYRIGHT]
...
<?php else: ?>
<?php /* Cached: August 25, 2012, 12:00 am */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: August 25, 2012, 12:00 am */  if (Phpfox ::getParam('like.show_user_photos')): ?>
