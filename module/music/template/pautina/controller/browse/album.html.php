    ...
    <div id="js_album_{$aAlbum.album_id}" class="js_album_parent {if $aAlbum.is_sponsor}row_sponsored {/if}{if $aAlbum.is_featured}row_featured {/if}{if is_int($phpfox.iteration.albums/2)}row1{else}row2{/if}{if $phpfox.iteration.albums == 1} row_first{/if}">
        <div class="row_title">
            ...
            <div class="row_title_image">
                ...
                <a href="{permalink module='music.album' id=$aAlbum.album_id title=$aAlbum.name}">
                    {img server_id=$aAlbum.server_id path='music.url_image' file=$aAlbum.image_path suffix='_200_square' max_width='200' max_height='200'}
                </a>
        ...
        <div class="row_title_info slide-block">
