...
<li>	
	...
	<a href="#" title="<?php echo Phpfox::getPhrase('friend.friend_requests'); ?>" class="friend_notification notify_drop_link" rel="friend.getRequests"><?php echo Phpfox::getPhrase('friend.friend_requests'); ?><span>Люди</span></span></a>
