...
<div class="p_bottom_5" style="position:relative;">
	<a class="all-items" href="{url link=''$aUser.user_name'.friend.mutual'}">
...
{foreach from=$aMutualFriends key=iKey name=friend item=aFriend}
		<li>{img user=$aFriend suffix='_100_square' max_width=100 max_height=100 class='js_hover_title'}</li>
{/foreach}
	</ul>
	<div class="clear"></div>
</div>
